...
export function createInvitation(http: HttpClient, rootUrl: string, params: CreateInvitation$Params, context?: HttpContext): Observable<StrictHttpResponse<InvitationResponse>> {
...
createInvitation.PATH = '/auth/invitations';
