...
import { UiTagComponent } from '../../primitives/tag/ui-tag.component';
import { UiTagVariant } from '../../primitives/tag/ui-tag.types';
...
export class UiDataTableComponent<T> implements OnChanges {
    ...
    @Input() density: UiTableDensity = 'default';
    ...
    private updatePaginatorLabels() {
        this.paginatorIntl.itemsPerPageLabel = this.i18n.itemsPerPageLabel || 'Elementos por página:';
        this.paginatorIntl.nextPageLabel = this.i18n.nextPageLabel || 'Siguiente';
        this.paginatorIntl.previousPageLabel = this.i18n.previousPageLabel || 'Anterior';
        this.paginatorIntl.firstPageLabel = this.i18n.firstPageLabel || 'Primera página';
        this.paginatorIntl.lastPageLabel = this.i18n.lastPageLabel || 'Última página';

        const rangeSeparator = this.i18n.rangeSeparatorLabel || 'de';
