...
@Component({
  ...
  styles: [`
    ...
    :host-context(.theme-dark) {
      .ui-toolbar {
        // Use the same token as light mode but allowing override.
        // Fallback to neutral dark surface if variable not set.
        background: var(--ui-toolbar-bg, rgba(30, 30, 30, 0.95));  
