...
import { DEFAULT_PAL_I18N, UiDialogI18n } from '../ui-i18n.types';
...
@Component({
  ...
  styles: [`
    .ui-confirm-dialog {
      padding: var(--ui-spacing-lg, 24px);
    ...
    .ui-confirm-dialog__icon {
      color: var(--ui-color-warning, #f59e0b); // Default warning color? Or customize
    }
    ...
    .ui-confirm-dialog__content {
      ...
      margin: 0;
      padding: 0; // Reset material padding
    }

    .ui-confirm-dialog__actions {
      display: flex;
      justify-content: flex-end;
      gap: var(--ui-spacing-sm, 12px);
      padding: 0; // Reset material padding
      margin-top: var(--ui-spacing-md, 8px);
    }
  `]
})
