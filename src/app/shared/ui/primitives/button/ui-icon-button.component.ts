...
@Component({
  ...
  styles: [`
    .ui-icon-button {
      ...
      &--sm { width: 32px; height: 32px; mat-icon { font-size: 18px; width: 18px; height: 18px; } }
      &--md { width: 40px; height: 40px; mat-icon { font-size: 24px; width: 24px; height: 24px; } }
      &--lg { width: 48px; height: 48px; mat-icon { font-size: 28px; width: 28px; height: 28px; } }
